...
public class KafkaTestResource implements QuarkusTestResourceLifecycleManager {
    ...
    public Map<String, String> start() {
        ...
        Map<String, String> props3 = InMemoryConnector.switchOutgoingChannelsToInMemory("homerobot-in");
        Map<String, String> props4 = InMemoryConnector.switchOutgoingChannelsToInMemory("prorobot-in");
